...
//	, produces = "application/json"
	...
	public void insertList(@RequestBody HashMap<String, Object> param){
		...
		System.out.println("µÊ123");

	}

//	@RequestMapping("list")
//	public List<FreeBoard> list() throws SQLException {
//		System.out.println("controllerÅ×½ºÆ®select");
...
//	      return map;
	...
	public List<FreeBoard> insertList(@RequestBody Map messageBody) throws SQLException, IOException {
		...
		System.out.println("¸Ö±î : " + messageBody);
		 ...
		 * System.out.println(jsonObject); System.out.println("ControllerÅ×½ºÆ®insert1 : "
		 * + jsonObject.get("Method"));
		 * 
		 * Object method = jsonObject.get("Method"); System.out.println("°Á method " +
